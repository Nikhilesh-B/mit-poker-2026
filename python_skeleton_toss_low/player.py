...
Tosses the LOWEST rank card (index 2 in canonicalized hand).
'''
...
class Player(Bot):
    '''
    A pokerbot that discards the lowest rank card.
    '''
    ...
    def get_action(self, game_state, round_state, active):
        ...
        if DiscardAction in legal_actions:
            # Discard the LOWEST rank card (index 2 in canonicalized hand)
            # Cards are sorted descending by rank: [highest, middle, lowest]
